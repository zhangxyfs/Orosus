...
import { Lexer, scanBalanced, scanBalancedStatements, skipBacktick, skipDollar, skipDoubleQuoted, skipSingleQuoted } from './lexer.ts';
import type { BalancedScan, HeredocBody, HeredocSpec, Token } from './lexer.ts';
import { SyntaxNodeBuilder } from './node.ts';
...
export class Parser {
  ...
  constructor(source: string, budget: ParseBudget, depth = 0) {
    this.source = source;
    this.budget = budget;
    this.depth = depth;
  }
